...
<head>
    ...
    <c:url var="categoryCss" value="/resources/css/category.css"/>
    <link rel="stylesheet" href="${categoryCss}">
</head>
...
<aside class="sidebar">
    ...
    <a href="#" class="nav-item-custom">Books</a>
    <a href="#" class="nav-item-custom active">Categories</a>
    <a href="#" class="nav-item-custom">Authors</a>
</aside>
...
<div class="main-content">
    ...
    <main class="page-content">
        <div class="page-heading d-flex flex-wrap justify-content-between align-items-center">
            <div>
                <p class="section-label mb-2">YOUR LIBRARY, ORGANIZED</p>
                <h1 class="h2 page-title">Categories</h1>
            ...
            <a href="${addUrl}" class="btn btn-brand px-4 py-2 mt-3 mt-md-0">
                + Add Category
            </a>
        </div>
        ...
        <div class="search-card">
            <form action="${listUrl}" method="get" class="search-form">
                <div class="form-row">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="btn search-btn btn-block">Search</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <c:choose>
                <c:when test="${empty categories}">
                    <div class="empty-state">
                        ...
                        <h2 class="h4 font-weight-bold">A fresh start for your library</h2>
                        <p class="text-muted">No categories found.</p>
                        <a href="${addUrl}" class="btn btn-brand mt-2">Create Category</a>
                    </div>
                </c:when>
                ...
                <c:otherwise>
                    ...
                    <c:if test="${totalPages > 1}">
                        <div class="pagination-area d-flex justify-content-between align-items-center">
                            ...
                            <nav>
                                <ul class="pagination pagination-sm">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <c:url var="previousUrl" value="/categories/list">
                                    ...
                                    <c:forEach var="pageNumber" begin="1" end="${totalPages}">
                                        <c:url var="pageUrl" value="/categories/list">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <c:url var="nextUrl" value="/categories/list">
                                                <c:param name="page" value="${currentPage + 1}"/>
                                                <c:if test="${not empty keyword}">
                                                    <c:param name="keyword" value="${keyword}"/>
                                                </c:if>
